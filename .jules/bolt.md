...
## 2025-05-14 - [Readability] Refactor tool descriptions to multi-line template literals
**Learning:** Using single-line strings with `\n` for long descriptions in the tool registry is hard to read and maintain. Multi-line template literals are preferred.
**Action:** Refactored all tools in `src/tools/registry.ts` with multi-line descriptions to use template literals. Verified with full test suite.
