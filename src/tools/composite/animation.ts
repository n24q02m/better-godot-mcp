...
async function handleCreatePlayer(
  ...
  validateNoNewlines('Invalid characters in parameters: newlines not allowed.', playerName, parent)
...
async function handleAddAnimation(
  ...
  validateNoNewlines('Invalid characters in anim_name: newlines not allowed.', animName)
...
async function handleAddTrack(
  ...
  validateNoNewlines('Invalid characters in parameters: newlines not allowed.', animName, trackType, nodePath, property)
