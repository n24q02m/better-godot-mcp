...
// ⚡ Bolt: Cache the docs directory to avoid redundant filesystem checks
...
async function getDocsDir(): Promise<string> {
  ...
  // ⚡ Bolt: Using sequential check to stop at the first match and avoid
  // redundant array creation and parallel filesystem operations
