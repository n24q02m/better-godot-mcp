  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        project_path: { type: 'string', description: 'Path to Godot project directory' },
        scene_path: { type: 'string', description: 'Path to scene file' },
        tileset_path: { type: 'string', description: 'Path to TileSet .tres file' },
        texture_path: { type: 'string', description: 'Texture source path' },
        tile_size: { type: 'number', description: 'Tile size in pixels (default: 16)' },
      },
      required: ['action'],
    },
  },
